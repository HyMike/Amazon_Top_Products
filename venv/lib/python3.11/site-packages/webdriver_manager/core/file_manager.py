...
class File(object):
    ...
    def filename(self) -> str:
        ...
        try:
            ...
            filenames = [re.findall(self.__regex_filename, element)
...
class FileManager(object):
    ...
    def save_archive_file(self, file: File, directory: str):
        ...
        if not os.path.exists(archive_path):
            raise FileExistsError(
                f"No file has been saved on such path {archive_path}")
    ...
    def __extract_zip(self, archive_file, to_directory):
        zip_class = (LinuxZipFileWithPermissions if self._os_system_manager.get_os_name(
