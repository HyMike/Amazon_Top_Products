...
if t.TYPE_CHECKING:
    # Don't type check the implementation below, pthread_kill does not exist
    # on Windows.
...
def _final_impl(decorated: type[T]) -> type[T]:
    ...
    decorated.__init_subclass__ = classmethod(
        _init_final_cls)  # type: ignore[assignment]
    # Apply the typing decorator, in 3.11+ it adds a __final__ marker
    # attribute.
