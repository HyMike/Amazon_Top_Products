...
def _family_for(ip: IPAddress) -> int:
    ...
    raise NotImplementedError(
        "Unhandled IPAddress instance type")  # pragma: no cover
...
def _wildcard_ip_for(family: int) -> IPAddress:
    ...
    raise NotImplementedError(
        "Unhandled ip address family")  # pragma: no cover
...
class UDPEndpoint:
    ...
    def as_python_sockaddr(
            self) -> tuple[str, int] | tuple[str, int, int, int]:
...
class FakeSocket(trio.socket.SocketType, metaclass=NoPublicConstructor):
    def __init__(
        ...
        # This is the source-of-truth for what port etc. this socket is bound
        # to
    ...
    # TODO: This method is not tested, and seems to make incorrect
    # assumptions. It should maybe raise NotImplementedError.
