...
class AsyncGenerators:
    ...
    # unexpected times.
    alive: _WEAK_ASYNC_GEN_SET | _ASYNC_GEN_SET = attr.ib(
    ...
    def install_hooks(self, runner: _run.Runner) -> None:
        ...
        def finalizer(agen: AsyncGeneratorType[object, NoReturn]) -> None:
            ...
            if is_ours:
                ...
                # Not ours -> forward to the host loop's async generator
                # finalizer
                if self.prev_hooks.finalizer is not None:
                    ...
                    try:
                        ...
                        # error than the default "async generator ignored
                        # GeneratorExit"
                        raise RuntimeError(
        ...
        # type: ignore[arg-type]  # Finalizer doesn't use AsyncGeneratorType
