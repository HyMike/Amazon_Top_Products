...
def test_raises_group() -> None:
    ...
    # currently not fully identical in behaviour to expect*, which would also
    # catch an unwrapped exception
...
def test_message() -> None:
    ...
    # multiple exceptions
    check_message(
        "ExceptionGroup(ValueError, ValueError)", RaisesGroup(
...
def test_matcher_tostring() -> None:
    ...
    assert str(Matcher(match=pattern_flags)
