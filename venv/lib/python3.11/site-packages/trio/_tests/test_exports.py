...
@pytest.mark.parametrize("tool", ["pylint",
                         "jedi", "mypy", "pyright_verifytypes"])
@pytest.mark.filterwarnings(
    # https://github.com/pypa/setuptools/issues/3274
    "ignore:module 'sre_constants' is deprecated:DeprecationWarning",
)
def test_static_tool_sees_all_symbols(
        tool: str, modname: str, tmp_path: Path) -> None:
...
def test_static_tool_sees_class_members(
    ...
    for class_name, class_ in module.__dict__.items():
        ...
        # also ignore some dunder methods that tend to differ but are of no
        # consequence
        ...
        if tool == "jedi":
            ...
            static_names = no_hidden(
                c.name for c in completions) - ignore_names
        ...
        # see
        # https://github.com/python-trio/trio/pull/2631#discussion_r1185615916
