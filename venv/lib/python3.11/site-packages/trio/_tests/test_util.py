...
def test_coroutine_or_error() -> None:
    ...
    with ignore_coroutine_never_awaited_warnings():
        ...
        if sys.version_info < (3, 11):
            ...
            with pytest.raises(TypeError) as excinfo:
                # type: ignore[arg-type, unused-coroutine]
        ...
        with pytest.raises(TypeError) as excinfo:
            # type: ignore[arg-type, unused-coroutine, return-value]
...
def test_fixup_module_metadata() -> None:
    ...
    # Bulild up a fake module to test. Just use lambdas since all we care
    # about is the names.
