    ...
    try:
        ...
        if exc.errno in _closed_stream_errnos:
            ...
            raise trio.BrokenResourceError(
                f"socket connection broken: {exc}") from exc
...
class SocketStream(HalfCloseableStream):
    ...
    @overload
    def setsockopt(self, level: int, option: int,
                   value: None, length: int) -> None:
        ...
