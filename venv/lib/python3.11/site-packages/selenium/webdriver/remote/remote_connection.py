...
class RemoteConnection:
    ...
    _ca_certs = os.getenv(
        "REQUESTS_CA_BUNDLE") if "REQUESTS_CA_BUNDLE" in os.environ else certifi.where()
    ...
    def __init__(self, remote_server_addr: str,
                 keep_alive: bool = False, ignore_proxy: bool = False):
