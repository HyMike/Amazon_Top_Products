...
def get_remote_connection(capabilities, command_executor,
...
class WebDriver(BaseWebDriver):
    ...
    def unpin(self, script_key: ScriptKey) -> None:
        ...
        try:
            ...
            raise KeyError(
                f"No script with key: {script_key} existed in {self.pinned_scripts}") from None
    ...
    def execute_script(self, script, *args):
        ...
        return self.execute(
            command, {"script": script, "args": converted_args})["value"]
    ...
    def find_element(self, by=By.ID,
    ...
    def find_elements(self, by=By.ID,
                      value: Optional[str] = None) -> List[WebElement]:
        ...
        if isinstance(by, RelativeBy):
            ...
            raw_function = pkgutil.get_data(
                _pkg, "findElements.js").decode("utf8")
    ...
    def _get_cdp_details(self):
        ...
        if self.caps.get("browserName") == "chrome":
            debugger_address = self.caps.get(
                "goog:chromeOptions").get("debuggerAddress")
        elif self.caps.get("browserName") == "msedge":
            debugger_address = self.caps.get(
                "ms:edgeOptions").get("debuggerAddress")
        else:
            _firefox = True
    ...
    def remove_virtual_authenticator(self) -> None:
        ...
        """
        self.execute(Command.REMOVE_VIRTUAL_AUTHENTICATOR, {
    ...
    def remove_all_credentials(self) -> None:
        ...
        self.execute(Command.REMOVE_ALL_CREDENTIALS,
                     {"authenticatorId": self._authenticator_id})
