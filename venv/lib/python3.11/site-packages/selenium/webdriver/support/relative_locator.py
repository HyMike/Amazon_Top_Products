...
class RelativeBy:
    ...
    def __init__(self, root: Optional[Dict[Union[By, str], str]]
                 = None, filters: Optional[List] = None):
    ...
    def above(
            self, element_or_locator: Union[WebElement, Dict] = None) -> "RelativeBy":
    ...
    def near(
            self, element_or_locator_distance: Union[WebElement, Dict, int] = None) -> "RelativeBy":
