...
class Color:
    ...
    @classmethod
    def _from_hsl(cls, h: ParseableFloat, s: ParseableFloat,
                  light: ParseableFloat, a: ParseableFloat = 1) -> Color:
        h = float(h) / 360
        s = float(s) / 100
        _l = float(light) / 100
    ...
    def __init__(self, red: ParseableInt, green: ParseableInt,
                 blue: ParseableInt, alpha: ParseableFloat = 1) -> None:
        self.red = int(red)
