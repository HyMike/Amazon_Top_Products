...
class RequestPattern:
    ...
    def from_json(cls, json):
        return cls(
            ...
            resource_type=network.ResourceType.from_json(
                json['resourceType']) if 'resourceType' in json else None,
            request_stage=RequestStage.from_json(
                json['requestStage']) if 'requestStage' in json else None,
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestPaused:
        return cls(
            ...
            response_status_text=str(
                json['responseStatusText']) if 'responseStatusText' in json else None,
            response_headers=[HeaderEntry.from_json(
                i) for i in json['responseHeaders']] if 'responseHeaders' in json else None,
            network_id=network.RequestId.from_json(
                json['networkId']) if 'networkId' in json else None,
            redirected_request_id=RequestId.from_json(
                json['redirectedRequestId']) if 'redirectedRequestId' in json else None
        )
