...
class DataEntry:
    ...
    def from_json(cls, json):
        return cls(
            ...
            request_headers=[Header.from_json(i)
                             for i in json['requestHeaders']],
            ...
            response_headers=[Header.from_json(i)
                              for i in json['responseHeaders']],
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            storage_bucket=storage.StorageBucket.from_json(
                json['storageBucket']) if 'storageBucket' in json else None,
        )
