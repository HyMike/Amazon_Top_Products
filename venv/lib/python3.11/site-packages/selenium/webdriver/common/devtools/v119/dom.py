...
class Node:
    ...
    def to_json(self):
        ...
        if self.pseudo_elements is not None:
            json['pseudoElements'] = [i.to_json()
                                      for i in self.pseudo_elements]
        ...
        if self.distributed_nodes is not None:
            json['distributedNodes'] = [i.to_json()
                                        for i in self.distributed_nodes]
    ...
    def from_json(cls, json):
        return cls(
            ...
            parent_id=NodeId.from_json(
                json['parentId']) if 'parentId' in json else None,
            child_node_count=int(
                json['childNodeCount']) if 'childNodeCount' in json else None,
            children=[
            ...
            internal_subset=str(
                json['internalSubset']) if 'internalSubset' in json else None,
            xml_version=str(
                json['xmlVersion']) if 'xmlVersion' in json else None,
            name=str(json['name']) if 'name' in json else None,
            value=str(json['value']) if 'value' in json else None,
            pseudo_type=PseudoType.from_json(
            ...
            shadow_root_type=ShadowRootType.from_json(
            ...
            content_document=Node.from_json(
                json['contentDocument']) if 'contentDocument' in json else None,
            shadow_roots=[Node.from_json(
                i) for i in json['shadowRoots']] if 'shadowRoots' in json else None,
            template_content=Node.from_json(
                json['templateContent']) if 'templateContent' in json else None,
            pseudo_elements=[Node.from_json(
                i) for i in json['pseudoElements']] if 'pseudoElements' in json else None,
            imported_document=Node.from_json(
                json['importedDocument']) if 'importedDocument' in json else None,
            distributed_nodes=[BackendNode.from_json(
                i) for i in json['distributedNodes']] if 'distributedNodes' in json else None,
            is_svg=bool(json['isSVG']) if 'isSVG' in json else None,
            compatibility_mode=CompatibilityMode.from_json(
                json['compatibilityMode']) if 'compatibilityMode' in json else None,
            assigned_slot=BackendNode.from_json(
                json['assignedSlot']) if 'assignedSlot' in json else None,
        )
...
class BoxModel:
    ...
    def from_json(cls, json):
        return cls(
            ...
            shape_outside=ShapeOutsideInfo.from_json(
                json['shapeOutside']) if 'shapeOutside' in json else None,
        )
...
def get_node_stack_traces(
    ...
    **EXPERIMENTAL**
    ...
    json = yield cmd_dict
    return runtime.StackTrace.from_json(
        json['creation']) if 'creation' in json else None
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> DistributedNodesUpdated:
        return cls(
            ...
            distributed_nodes=[BackendNode.from_json(
                i) for i in json['distributedNodes']]
        )
