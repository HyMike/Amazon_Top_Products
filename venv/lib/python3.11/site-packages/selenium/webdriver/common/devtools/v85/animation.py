...
class Animation:
    ...
    def from_json(cls, json):
        return cls(
            ...
            type_=str(json['type']),
            source=AnimationEffect.from_json(
                json['source']) if 'source' in json else None,
...
class AnimationEffect:
    ...
    def from_json(cls, json):
        return cls(
            ...
            keyframes_rule=KeyframesRule.from_json(
                json['keyframesRule']) if 'keyframesRule' in json else None,
        )
