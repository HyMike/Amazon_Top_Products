...
class GPUInfo:
    ...
    def from_json(cls, json):
        return cls(
            ...
            aux_attributes=dict(
                json['auxAttributes']) if 'auxAttributes' in json else None,
            feature_status=dict(
                json['featureStatus']) if 'featureStatus' in json else None,
        )
...
def get_info() -> typing.Generator[T_JSON_DICT,
                                   T_JSON_DICT, typing.Tuple[GPUInfo, str, str, str]]:
    '''
