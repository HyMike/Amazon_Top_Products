    ...
    def from_json(cls, json):
        return cls(
            ...
            certificate_network_error=str(
                json['certificateNetworkError']) if 'certificateNetworkError' in json else None,
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            certificate_security_state=CertificateSecurityState.from_json(
                json['certificateSecurityState']) if 'certificateSecurityState' in json else None,
            safety_tip_info=SafetyTipInfo.from_json(
                json['safetyTipInfo']) if 'safetyTipInfo' in json else None,
        )
...
class SecurityStateChanged:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SecurityStateChanged:
        return cls(
            ...
            explanations=[SecurityStateExplanation.from_json(
