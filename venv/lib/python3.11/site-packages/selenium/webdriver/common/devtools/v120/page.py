...
class AdFrameStatus:
    ...
    def from_json(cls, json):
        return cls(
            ...
            explanations=[AdFrameExplanation.from_json(
                i) for i in json['explanations']] if 'explanations' in json else None,
        )
...
class PermissionsPolicyFeatureState:
    ...
    def from_json(cls, json):
        return cls(
            ...
            locator=PermissionsPolicyBlockLocator.from_json(
                json['locator']) if 'locator' in json else None,
        )
...
class OriginTrialTokenWithStatus:
    ...
    def from_json(cls, json):
        return cls(
            ...
            parsed_token=OriginTrialToken.from_json(
                json['parsedToken']) if 'parsedToken' in json else None,
        )
...
class OriginTrial:
    ...
    def to_json(self):
        ...
        json['trialName'] = self.trial_name
        json['status'] = self.status.to_json()
        json['tokensWithStatus'] = [i.to_json()
                                    for i in self.tokens_with_status]
        return json
    ...
    def from_json(cls, json):
        return cls(
            ...
            tokens_with_status=[OriginTrialTokenWithStatus.from_json(
                i) for i in json['tokensWithStatus']],
        )
...
class Frame:
    ...
    def to_json(self):
        ...
        json['gatedAPIFeatures'] = [i.to_json()
                                    for i in self.gated_api_features]
    ...
    def from_json(cls, json):
        return cls(
            ...
            gated_api_features=[GatedAPIFeatures.from_json(
                i) for i in json['gatedAPIFeatures']],
            parent_id=FrameId.from_json(
                json['parentId']) if 'parentId' in json else None,
            name=str(json['name']) if 'name' in json else None,
            url_fragment=str(
                json['urlFragment']) if 'urlFragment' in json else None,
            unreachable_url=str(
                json['unreachableUrl']) if 'unreachableUrl' in json else None,
            ad_frame_status=AdFrameStatus.from_json(
    ...
    def from_json(cls, json):
        return cls(
            ...
            last_modified=network.TimeSinceEpoch.from_json(
                json['lastModified']) if 'lastModified' in json else None,
            content_size=float(
                json['contentSize']) if 'contentSize' in json else None,
...
class FrameResourceTree:
    ...
    def from_json(cls, json):
        return cls(
            ...
            child_frames=[FrameResourceTree.from_json(
                i) for i in json['childFrames']] if 'childFrames' in json else None,
        )
...
class FrameTree:
    ...
    def from_json(cls, json):
        return cls(
            frame=Frame.from_json(json['frame']),
            child_frames=[FrameTree.from_json(
                i) for i in json['childFrames']] if 'childFrames' in json else None,
        )
...
class ScreencastFrameMetadata:
    ...
    def from_json(cls, json):
        return cls(
            ...
            timestamp=network.TimeSinceEpoch.from_json(
                json['timestamp']) if 'timestamp' in json else None,
        )
...
class InstallabilityError:
    ...
    def from_json(cls, json):
        return cls(
            ...
            error_arguments=[InstallabilityErrorArgument.from_json(
                i) for i in json['errorArguments']],
        )
...
class BackForwardCacheNotRestoredExplanation:
    ...
    def from_json(cls, json):
        return cls(
            ...
            details=[BackForwardCacheBlockingDetails.from_json(
                i) for i in json['details']] if 'details' in json else None,
        )
...
class BackForwardCacheNotRestoredExplanationTree:
    ...
    def from_json(cls, json):
        return cls(
            url=str(json['url']),
            explanations=[BackForwardCacheNotRestoredExplanation.from_json(
                i) for i in json['explanations']],
            children=[BackForwardCacheNotRestoredExplanationTree.from_json(
...
def get_app_manifest() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, typing.Tuple[str,
                                                                                  typing.List[AppManifestError], typing.Optional[str], typing.Optional[AppManifestParsedProperties]]]:
    '''
    ...
    return (
        ...
        AppManifestParsedProperties.from_json(
            json['parsed']) if 'parsed' in json else None
    )
...
def get_installability_errors(
    ...
    **EXPERIMENTAL**
    ...
    json = yield cmd_dict
    return [InstallabilityError.from_json(i)
            for i in json['installabilityErrors']]
...
def get_app_id() -> typing.Generator[T_JSON_DICT, T_JSON_DICT,
...
def get_ad_script_id(
    ...
    **EXPERIMENTAL**
    ...
    json = yield cmd_dict
    return AdScriptId.from_json(
        json['adScriptId']) if 'adScriptId' in json else None


def get_cookies() -> typing.Generator[T_JSON_DICT,
                                      T_JSON_DICT, typing.List[network.Cookie]]:
    '''
...
def get_layout_metrics() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, typing.Tuple[LayoutViewport,
                                                                                    VisualViewport, dom.Rect, LayoutViewport, VisualViewport, dom.Rect]]:
    '''
...
def navigate(
    ...
    return (
        ...
        network.LoaderId.from_json(
            json['loaderId']) if 'loaderId' in json else None,
    ...
    def from_json(cls, json: T_JSON_DICT) -> FileChooserOpened:
        return cls(
            ...
            backend_node_id=dom.BackendNodeId.from_json(
                json['backendNodeId']) if 'backendNodeId' in json else None
        )
...
class JavascriptDialogOpening:
    ...
    def from_json(cls, json: T_JSON_DICT) -> JavascriptDialogOpening:
        return cls(
            ...
            default_prompt=str(
                json['defaultPrompt']) if 'defaultPrompt' in json else None
        )
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> BackForwardCacheNotUsed:
        return cls(
            loader_id=network.LoaderId.from_json(json['loaderId']),
            frame_id=FrameId.from_json(json['frameId']),
            not_restored_explanations=[BackForwardCacheNotRestoredExplanation.from_json(
                i) for i in json['notRestoredExplanations']],
