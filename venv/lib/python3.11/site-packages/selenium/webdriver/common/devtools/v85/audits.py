...
class SameSiteCookieIssueDetails:
    ...
    def from_json(cls, json):
        return cls(
            ...
            cookie_warning_reasons=[SameSiteCookieWarningReason.from_json(
                i) for i in json['cookieWarningReasons']],
            cookie_exclusion_reasons=[SameSiteCookieExclusionReason.from_json(
    ...
    def from_json(cls, json):
        return cls(
            same_site_cookie_issue_details=SameSiteCookieIssueDetails.from_json(
                json['sameSiteCookieIssueDetails']) if 'sameSiteCookieIssueDetails' in json else None,
