    ...
    def from_json(cls, json):
        return cls(
            ...
            additional_parameters=dict(
                json['additionalParameters']) if 'additionalParameters' in json else None,
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            weak_local_object_reference=int(
                json['weakLocalObjectReference']) if 'weakLocalObjectReference' in json else None,
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            unserializable_value=UnserializableValue.from_json(
                json['unserializableValue']) if 'unserializableValue' in json else None,
            description=str(
                json['description']) if 'description' in json else None,
            web_driver_value=DeepSerializedValue.from_json(
                json['webDriverValue']) if 'webDriverValue' in json else None,
            deep_serialized_value=DeepSerializedValue.from_json(
                json['deepSerializedValue']) if 'deepSerializedValue' in json else None,
            object_id=RemoteObjectId.from_json(
                json['objectId']) if 'objectId' in json else None,
            preview=ObjectPreview.from_json(
                json['preview']) if 'preview' in json else None,
            custom_preview=CustomPreview.from_json(
                json['customPreview']) if 'customPreview' in json else None,
        )
...
class CustomPreview:
    ...
    def from_json(cls, json):
        return cls(
            ...
            body_getter_id=RemoteObjectId.from_json(
                json['bodyGetterId']) if 'bodyGetterId' in json else None,
        )
...
class ObjectPreview:
    ...
    def from_json(cls, json):
        return cls(
            ...
            properties=[PropertyPreview.from_json(
                i) for i in json['properties']],
            subtype=str(json['subtype']) if 'subtype' in json else None,
            description=str(
                json['description']) if 'description' in json else None,
            entries=[EntryPreview.from_json(
                i) for i in json['entries']] if 'entries' in json else None,
        )
...
class PropertyPreview:
    ...
    def from_json(cls, json):
        return cls(
            ...
            value_preview=ObjectPreview.from_json(
                json['valuePreview']) if 'valuePreview' in json else None,
            subtype=str(json['subtype']) if 'subtype' in json else None,
        )
...
class EntryPreview:
    ...
    def from_json(cls, json):
        return cls(
            ...
            key=ObjectPreview.from_json(
                json['key']) if 'key' in json else None,
        )
...
class PropertyDescriptor:
    ...
    def from_json(cls, json):
        return cls(
            ...
            value=RemoteObject.from_json(
                json['value']) if 'value' in json else None,
            writable=bool(json['writable']) if 'writable' in json else None,
            get=RemoteObject.from_json(json['get']) if 'get' in json else None,
            set_=RemoteObject.from_json(
                json['set']) if 'set' in json else None,
            was_thrown=bool(
                json['wasThrown']) if 'wasThrown' in json else None,
            is_own=bool(json['isOwn']) if 'isOwn' in json else None,
            symbol=RemoteObject.from_json(
                json['symbol']) if 'symbol' in json else None,
        )
...
class ExceptionDetails:
    ...
    def from_json(cls, json):
        return cls(
            ...
            script_id=ScriptId.from_json(
                json['scriptId']) if 'scriptId' in json else None,
            url=str(json['url']) if 'url' in json else None,
            stack_trace=StackTrace.from_json(
                json['stackTrace']) if 'stackTrace' in json else None,
            exception=RemoteObject.from_json(
                json['exception']) if 'exception' in json else None,
            execution_context_id=ExecutionContextId.from_json(
                json['executionContextId']) if 'executionContextId' in json else None,
            exception_meta_data=dict(
                json['exceptionMetaData']) if 'exceptionMetaData' in json else None,
        )
...
class StackTrace:
    ...
    def from_json(cls, json):
        return cls(
            ...
            description=str(
                json['description']) if 'description' in json else None,
            parent=StackTrace.from_json(
                json['parent']) if 'parent' in json else None,
            parent_id=StackTraceId.from_json(
...
class StackTraceId:
    ...
    def from_json(cls, json):
        return cls(
            id_=str(json['id']),
            debugger_id=UniqueDebuggerId.from_json(
                json['debuggerId']) if 'debuggerId' in json else None,
        )
...
def await_promise(
    ...
    return (
        ...
        ExceptionDetails.from_json(
            json['exceptionDetails']) if 'exceptionDetails' in json else None
    )
...
def get_properties(
    ...
    return (
        ...
        [InternalPropertyDescriptor.from_json(
            i) for i in json['internalProperties']] if 'internalProperties' in json else None,
        [PrivatePropertyDescriptor.from_json(
            i) for i in json['privateProperties']] if 'privateProperties' in json else None,
        ExceptionDetails.from_json(
            json['exceptionDetails']) if 'exceptionDetails' in json else None
    )
