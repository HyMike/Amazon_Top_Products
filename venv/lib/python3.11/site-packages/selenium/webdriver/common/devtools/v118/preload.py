...
class RuleSet:
    ...
    def from_json(cls, json):
        return cls(
            ...
            error_type=RuleSetErrorType.from_json(
                json['errorType']) if 'errorType' in json else None,
            error_message=str(
                json['errorMessage']) if 'errorMessage' in json else None,
        )
...
class PreloadingAttemptKey:
    ...
    def from_json(cls, json):
        return cls(
            ...
            url=str(json['url']),
            target_hint=SpeculationTargetHint.from_json(
                json['targetHint']) if 'targetHint' in json else None,
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> PrerenderAttemptCompleted:
        return cls(
            ...
            disallowed_api_method=str(
                json['disallowedApiMethod']) if 'disallowedApiMethod' in json else None
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> PrerenderStatusUpdated:
        return cls(
            ...
            prerender_status=PrerenderFinalStatus.from_json(
                json['prerenderStatus']) if 'prerenderStatus' in json else None,
            disallowed_mojo_interface=str(
                json['disallowedMojoInterface']) if 'disallowedMojoInterface' in json else None
        )
...
class PreloadingAttemptSourcesUpdated:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PreloadingAttemptSourcesUpdated:
        return cls(
            loader_id=network.LoaderId.from_json(json['loaderId']),
            preloading_attempt_sources=[PreloadingAttemptSource.from_json(
                i) for i in json['preloadingAttemptSources']]
        )
