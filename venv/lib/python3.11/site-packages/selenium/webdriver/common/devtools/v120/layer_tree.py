    ...
    def from_json(cls, json):
        return cls(
            ...
            nearest_layer_shifting_sticky_box=LayerId.from_json(
                json['nearestLayerShiftingStickyBox']) if 'nearestLayerShiftingStickyBox' in json else None,
            nearest_layer_shifting_containing_block=LayerId.from_json(
                json['nearestLayerShiftingContainingBlock']) if 'nearestLayerShiftingContainingBlock' in json else None,
        )
...
class Layer:
    ...
    def from_json(cls, json):
        return cls(
            ...
            parent_layer_id=LayerId.from_json(
                json['parentLayerId']) if 'parentLayerId' in json else None,
            ...
            transform=[float(i) for i in json['transform']
                       ] if 'transform' in json else None,
            ...
            scroll_rects=[ScrollRect.from_json(
            ...
            sticky_position_constraint=StickyPositionConstraint.from_json(
                json['stickyPositionConstraint']) if 'stickyPositionConstraint' in json else None,
        )
