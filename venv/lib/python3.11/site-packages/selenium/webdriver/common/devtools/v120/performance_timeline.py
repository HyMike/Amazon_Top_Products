...
class LargestContentfulPaint:
    ...
    def from_json(cls, json):
        return cls(
            ...
            node_id=dom.BackendNodeId.from_json(
                json['nodeId']) if 'nodeId' in json else None,
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            last_input_time=network.TimeSinceEpoch.from_json(
                json['lastInputTime']),
            sources=[LayoutShiftAttribution.from_json(
                i) for i in json['sources']],
        )
...
class TimelineEvent:
    ...
    def from_json(cls, json):
        return cls(
            ...
            lcp_details=LargestContentfulPaint.from_json(
                json['lcpDetails']) if 'lcpDetails' in json else None,
            layout_shift_details=LayoutShift.from_json(
                json['layoutShiftDetails']) if 'layoutShiftDetails' in json else None,
        )
