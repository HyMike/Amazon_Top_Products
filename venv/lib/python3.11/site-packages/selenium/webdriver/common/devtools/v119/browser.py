...
class Bounds:
    ...
    def from_json(cls, json):
        return cls(
            ...
            window_state=WindowState.from_json(
                json['windowState']) if 'windowState' in json else None,
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            user_visible_only=bool(
                json['userVisibleOnly']) if 'userVisibleOnly' in json else None,
            allow_without_sanitization=bool(
                json['allowWithoutSanitization']) if 'allowWithoutSanitization' in json else None,
            pan_tilt_zoom=bool(
                json['panTiltZoom']) if 'panTiltZoom' in json else None,
        )
...
def get_version() -> typing.Generator[T_JSON_DICT,
                                      T_JSON_DICT, typing.Tuple[str, str, str, str, str]]:
    '''
