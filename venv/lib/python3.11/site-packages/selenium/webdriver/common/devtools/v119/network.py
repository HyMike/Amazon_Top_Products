...
class Request:
    ...
    def to_json(self):
        ...
        if self.post_data_entries is not None:
            json['postDataEntries'] = [i.to_json()
                                       for i in self.post_data_entries]
    ...
    def from_json(cls, json):
        return cls(
            ...
            url_fragment=str(
                json['urlFragment']) if 'urlFragment' in json else None,
            post_data=str(json['postData']) if 'postData' in json else None,
            has_post_data=bool(
                json['hasPostData']) if 'hasPostData' in json else None,
            post_data_entries=[PostDataEntry.from_json(
                i) for i in json['postDataEntries']] if 'postDataEntries' in json else None,
            mixed_content_type=security.MixedContentType.from_json(
                json['mixedContentType']) if 'mixedContentType' in json else None,
            is_link_preload=bool(
                json['isLinkPreload']) if 'isLinkPreload' in json else None,
            trust_token_params=TrustTokenParams.from_json(
                json['trustTokenParams']) if 'trustTokenParams' in json else None,
            is_same_site=bool(
                json['isSameSite']) if 'isSameSite' in json else None,
        )
...
class SecurityDetails:
    ...
    def from_json(cls, json):
        return cls(
            ...
            signed_certificate_timestamp_list=[SignedCertificateTimestamp.from_json(
                i) for i in json['signedCertificateTimestampList']],
            ...
            key_exchange_group=str(
                json['keyExchangeGroup']) if 'keyExchangeGroup' in json else None,
            mac=str(json['mac']) if 'mac' in json else None,
            server_signature_algorithm=int(
                json['serverSignatureAlgorithm']) if 'serverSignatureAlgorithm' in json else None,
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            security_state=security.SecurityState.from_json(
                json['securityState']),
            headers_text=str(
                json['headersText']) if 'headersText' in json else None,
            request_headers=Headers.from_json(
                json['requestHeaders']) if 'requestHeaders' in json else None,
            request_headers_text=str(
                json['requestHeadersText']) if 'requestHeadersText' in json else None,
            remote_ip_address=str(
                json['remoteIPAddress']) if 'remoteIPAddress' in json else None,
            remote_port=int(
                json['remotePort']) if 'remotePort' in json else None,
            from_disk_cache=bool(
                json['fromDiskCache']) if 'fromDiskCache' in json else None,
            from_service_worker=bool(
                json['fromServiceWorker']) if 'fromServiceWorker' in json else None,
            from_prefetch_cache=bool(
                json['fromPrefetchCache']) if 'fromPrefetchCache' in json else None,
            timing=ResourceTiming.from_json(
                json['timing']) if 'timing' in json else None,
            service_worker_response_source=ServiceWorkerResponseSource.from_json(
                json['serviceWorkerResponseSource']) if 'serviceWorkerResponseSource' in json else None,
            response_time=TimeSinceEpoch.from_json(
                json['responseTime']) if 'responseTime' in json else None,
            cache_storage_cache_name=str(
                json['cacheStorageCacheName']) if 'cacheStorageCacheName' in json else None,
            protocol=str(json['protocol']) if 'protocol' in json else None,
            alternate_protocol_usage=AlternateProtocolUsage.from_json(
                json['alternateProtocolUsage']) if 'alternateProtocolUsage' in json else None,
            security_details=SecurityDetails.from_json(
                json['securityDetails']) if 'securityDetails' in json else None,
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            response=Response.from_json(
                json['response']) if 'response' in json else None,
        )
...
class Initiator:
    ...
    def from_json(cls, json):
        return cls(
            type_=str(json['type']),
            stack=runtime.StackTrace.from_json(
                json['stack']) if 'stack' in json else None,
            url=str(json['url']) if 'url' in json else None,
            line_number=float(
                json['lineNumber']) if 'lineNumber' in json else None,
            column_number=float(
                json['columnNumber']) if 'columnNumber' in json else None,
            request_id=RequestId.from_json(
...
class Cookie:
    ...
    def from_json(cls, json):
        return cls(
            ...
            same_site=CookieSameSite.from_json(
                json['sameSite']) if 'sameSite' in json else None,
            partition_key=str(
                json['partitionKey']) if 'partitionKey' in json else None,
            partition_key_opaque=bool(
                json['partitionKeyOpaque']) if 'partitionKeyOpaque' in json else None,
        )
...
class BlockedSetCookieWithReason:
    ...
    def from_json(cls, json):
        return cls(
            blocked_reasons=[SetCookieBlockedReason.from_json(
                i) for i in json['blockedReasons']],
            cookie_line=str(json['cookieLine']),
            cookie=Cookie.from_json(
                json['cookie']) if 'cookie' in json else None,
        )
...
class BlockedCookieWithReason:
    ...
    def from_json(cls, json):
        return cls(
            blocked_reasons=[CookieBlockedReason.from_json(
                i) for i in json['blockedReasons']],
...
class CookieParam:
    ...
    def from_json(cls, json):
        return cls(
            ...
            same_site=CookieSameSite.from_json(
                json['sameSite']) if 'sameSite' in json else None,
            expires=TimeSinceEpoch.from_json(
                json['expires']) if 'expires' in json else None,
            priority=CookiePriority.from_json(
                json['priority']) if 'priority' in json else None,
            same_party=bool(
                json['sameParty']) if 'sameParty' in json else None,
            source_scheme=CookieSourceScheme.from_json(
                json['sourceScheme']) if 'sourceScheme' in json else None,
            source_port=int(
                json['sourcePort']) if 'sourcePort' in json else None,
            partition_key=str(
                json['partitionKey']) if 'partitionKey' in json else None,
        )
...
class RequestPattern:
    ...
    def from_json(cls, json):
        return cls(
            url_pattern=str(
                json['urlPattern']) if 'urlPattern' in json else None,
            resource_type=ResourceType.from_json(
                json['resourceType']) if 'resourceType' in json else None,
            interception_stage=InterceptionStage.from_json(
                json['interceptionStage']) if 'interceptionStage' in json else None,
        )
...
class SignedExchangeSignature:
    ...
    def from_json(cls, json):
        return cls(
            ...
            cert_sha256=str(
                json['certSha256']) if 'certSha256' in json else None,
            certificates=[str(i) for i in json['certificates']
                          ] if 'certificates' in json else None,
        )
...
class SignedExchangeHeader:
    ...
    def from_json(cls, json):
        return cls(
            ...
            signatures=[SignedExchangeSignature.from_json(
                i) for i in json['signatures']],
...
class SignedExchangeError:
    ...
    def from_json(cls, json):
        return cls(
            ...
            signature_index=int(
                json['signatureIndex']) if 'signatureIndex' in json else None,
            error_field=SignedExchangeErrorField.from_json(
                json['errorField']) if 'errorField' in json else None,
        )
...
class SignedExchangeInfo:
    ...
    def from_json(cls, json):
        return cls(
            ...
            header=SignedExchangeHeader.from_json(
                json['header']) if 'header' in json else None,
            security_details=SecurityDetails.from_json(
                json['securityDetails']) if 'securityDetails' in json else None,
            errors=[SignedExchangeError.from_json(
                i) for i in json['errors']] if 'errors' in json else None,
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            reporting_endpoint=str(
                json['reportingEndpoint']) if 'reportingEndpoint' in json else None,
            report_only_reporting_endpoint=str(
                json['reportOnlyReportingEndpoint']) if 'reportOnlyReportingEndpoint' in json else None,
        )
...
class SecurityIsolationStatus:
    ...
    def from_json(cls, json):
        return cls(
            coop=CrossOriginOpenerPolicyStatus.from_json(
                json['coop']) if 'coop' in json else None,
            coep=CrossOriginEmbedderPolicyStatus.from_json(
                json['coep']) if 'coep' in json else None,
            csp=[ContentSecurityPolicyStatus.from_json(
                i) for i in json['csp']] if 'csp' in json else None,
        )
...
class LoadNetworkResourcePageResult:
    ...
    def from_json(cls, json):
        return cls(
            ...
            net_error_name=str(
                json['netErrorName']) if 'netErrorName' in json else None,
            http_status_code=float(
                json['httpStatusCode']) if 'httpStatusCode' in json else None,
            stream=io.StreamHandle.from_json(
                json['stream']) if 'stream' in json else None,
            headers=network.Headers.from_json(
                json['headers']) if 'headers' in json else None,
        )
...
class LoadingFailed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LoadingFailed:
        return cls(
            ...
            blocked_reason=BlockedReason.from_json(
                json['blockedReason']) if 'blockedReason' in json else None,
            cors_error_status=CorsErrorStatus.from_json(
                json['corsErrorStatus']) if 'corsErrorStatus' in json else None
        )
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestIntercepted:
        return cls(
            ...
            is_download=bool(
                json['isDownload']) if 'isDownload' in json else None,
            redirect_url=str(
                json['redirectUrl']) if 'redirectUrl' in json else None,
            auth_challenge=AuthChallenge.from_json(
                json['authChallenge']) if 'authChallenge' in json else None,
            response_error_reason=ErrorReason.from_json(
                json['responseErrorReason']) if 'responseErrorReason' in json else None,
            response_status_code=int(
                json['responseStatusCode']) if 'responseStatusCode' in json else None,
            response_headers=Headers.from_json(
                json['responseHeaders']) if 'responseHeaders' in json else None,
            request_id=RequestId.from_json(
                json['requestId']) if 'requestId' in json else None
        )
...
class RequestWillBeSent:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSent:
        return cls(
            ...
            redirect_response=Response.from_json(
                json['redirectResponse']) if 'redirectResponse' in json else None,
            type_=ResourceType.from_json(
                json['type']) if 'type' in json else None,
            frame_id=page.FrameId.from_json(
                json['frameId']) if 'frameId' in json else None,
            has_user_gesture=bool(
                json['hasUserGesture']) if 'hasUserGesture' in json else None
        )
...
class WebSocketCreated:
    ...
    def from_json(cls, json: T_JSON_DICT) -> WebSocketCreated:
        return cls(
            request_id=RequestId.from_json(json['requestId']),
            url=str(json['url']),
            initiator=Initiator.from_json(
                json['initiator']) if 'initiator' in json else None
        )
...
class WebSocketHandshakeResponseReceived:
    ...
    @classmethod
    def from_json(
            cls, json: T_JSON_DICT) -> WebSocketHandshakeResponseReceived:
        return cls(
            request_id=RequestId.from_json(json['requestId']),
            timestamp=MonotonicTime.from_json(json['timestamp']),
...
class RequestWillBeSentExtraInfo:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSentExtraInfo:
        return cls(
            request_id=RequestId.from_json(json['requestId']),
            associated_cookies=[BlockedCookieWithReason.from_json(
                i) for i in json['associatedCookies']],
            headers=Headers.from_json(json['headers']),
            connect_timing=ConnectTiming.from_json(json['connectTiming']),
            client_security_state=ClientSecurityState.from_json(
                json['clientSecurityState']) if 'clientSecurityState' in json else None,
            site_has_cookie_in_other_partition=bool(
                json['siteHasCookieInOtherPartition']) if 'siteHasCookieInOtherPartition' in json else None
        )
...
class ResponseReceivedExtraInfo:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ResponseReceivedExtraInfo:
        return cls(
            request_id=RequestId.from_json(json['requestId']),
            blocked_cookies=[BlockedSetCookieWithReason.from_json(
                i) for i in json['blockedCookies']],
            headers=Headers.from_json(json['headers']),
            ...
            cookie_partition_key=str(
                json['cookiePartitionKey']) if 'cookiePartitionKey' in json else None,
            cookie_partition_key_opaque=bool(
                json['cookiePartitionKeyOpaque']) if 'cookiePartitionKeyOpaque' in json else None
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> TrustTokenOperationDone:
        return cls(
            ...
            top_level_origin=str(
                json['topLevelOrigin']) if 'topLevelOrigin' in json else None,
            issuer_origin=str(
                json['issuerOrigin']) if 'issuerOrigin' in json else None,
            issued_token_count=int(
                json['issuedTokenCount']) if 'issuedTokenCount' in json else None
        )
...
class SubresourceWebBundleMetadataReceived:
    ...
    **EXPERIMENTAL**
    ...
    @classmethod
    def from_json(
            cls, json: T_JSON_DICT) -> SubresourceWebBundleMetadataReceived:
        return cls(
            request_id=RequestId.from_json(json['requestId']),
...
class SubresourceWebBundleInnerResponseParsed:
    ...
    **EXPERIMENTAL**
    ...
    @classmethod
    def from_json(
            cls, json: T_JSON_DICT) -> SubresourceWebBundleInnerResponseParsed:
        return cls(
            inner_request_id=RequestId.from_json(json['innerRequestId']),
            inner_request_url=str(json['innerRequestURL']),
            bundle_request_id=RequestId.from_json(
                json['bundleRequestId']) if 'bundleRequestId' in json else None
        )
...
class SubresourceWebBundleInnerResponseError:
    ...
    **EXPERIMENTAL**
    ...
    @classmethod
    def from_json(
            cls, json: T_JSON_DICT) -> SubresourceWebBundleInnerResponseError:
        return cls(
            inner_request_id=RequestId.from_json(json['innerRequestId']),
            inner_request_url=str(json['innerRequestURL']),
            error_message=str(json['errorMessage']),
...
class ReportingApiEndpointsChangedForOrigin:
    ...
    **EXPERIMENTAL**
    ...
    @classmethod
    def from_json(
            cls, json: T_JSON_DICT) -> ReportingApiEndpointsChangedForOrigin:
        return cls(
            origin=str(json['origin']),
            endpoints=[ReportingApiEndpoint.from_json(
                i) for i in json['endpoints']]
        )
