...
class CallFrame:
    ...
    def from_json(cls, json):
        return cls(
            ...
            function_location=Location.from_json(
                json['functionLocation']) if 'functionLocation' in json else None,
            return_value=runtime.RemoteObject.from_json(
                json['returnValue']) if 'returnValue' in json else None,
            can_be_restarted=bool(
                json['canBeRestarted']) if 'canBeRestarted' in json else None,
        )
...
class Scope:
    ...
    def from_json(cls, json):
        return cls(
            ...
            start_location=Location.from_json(
                json['startLocation']) if 'startLocation' in json else None,
            end_location=Location.from_json(
                json['endLocation']) if 'endLocation' in json else None,
        )
...
class DebugSymbols:
    ...
    def from_json(cls, json):
        return cls(
            type_=str(json['type']),
            external_url=str(
                json['externalURL']) if 'externalURL' in json else None,
        )
...
def evaluate_on_call_frame(
    ...
    return (
        ...
        runtime.ExceptionDetails.from_json(
...
def restart_frame(
    ...
    return (
        ...
        runtime.StackTrace.from_json(
            json['asyncStackTrace']) if 'asyncStackTrace' in json else None,
        runtime.StackTraceId.from_json(
            json['asyncStackTraceId']) if 'asyncStackTraceId' in json else None
    )
...
def set_script_source(
    ...
    return (
        [CallFrame.from_json(i) for i in json['callFrames']
         ] if 'callFrames' in json else None,
    ...
    def from_json(cls, json: T_JSON_DICT) -> Paused:
        return cls(
            ...
            async_call_stack_trace_id=runtime.StackTraceId.from_json(
                json['asyncCallStackTraceId']) if 'asyncCallStackTraceId' in json else None
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScriptFailedToParse:
        return cls(
            ...
            execution_context_aux_data=dict(
                json['executionContextAuxData']) if 'executionContextAuxData' in json else None,
            source_map_url=str(
            ...
            stack_trace=runtime.StackTrace.from_json(
                json['stackTrace']) if 'stackTrace' in json else None,
            code_offset=int(
                json['codeOffset']) if 'codeOffset' in json else None,
            script_language=debugger.ScriptLanguage.from_json(
                json['scriptLanguage']) if 'scriptLanguage' in json else None,
            embedder_name=str(
                json['embedderName']) if 'embedderName' in json else None
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScriptParsed:
        return cls(
            ...
            execution_context_aux_data=dict(
                json['executionContextAuxData']) if 'executionContextAuxData' in json else None,
            is_live_edit=bool(
                json['isLiveEdit']) if 'isLiveEdit' in json else None,
            source_map_url=str(
                json['sourceMapURL']) if 'sourceMapURL' in json else None,
            has_source_url=bool(
                json['hasSourceURL']) if 'hasSourceURL' in json else None,
            ...
            script_language=debugger.ScriptLanguage.from_json(
                json['scriptLanguage']) if 'scriptLanguage' in json else None,
            debug_symbols=debugger.DebugSymbols.from_json(
                json['debugSymbols']) if 'debugSymbols' in json else None,
            embedder_name=str(
                json['embedderName']) if 'embedderName' in json else None
        )
