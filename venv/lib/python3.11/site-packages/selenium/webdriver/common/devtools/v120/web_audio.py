...
class BaseAudioContext:
    ...
    def from_json(cls, json):
        return cls(
            ...
            realtime_data=ContextRealtimeData.from_json(
    ...
    def from_json(cls, json: T_JSON_DICT) -> NodesConnected:
        return cls(
            ...
            source_output_index=float(
                json['sourceOutputIndex']) if 'sourceOutputIndex' in json else None,
            destination_input_index=float(
                json['destinationInputIndex']) if 'destinationInputIndex' in json else None
        )
