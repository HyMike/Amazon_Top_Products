...
class TraceConfig:
    ...
    def from_json(cls, json):
        return cls(
            record_mode=str(
                json['recordMode']) if 'recordMode' in json else None,
            ...
            included_categories=[
                str(i) for i in json['includedCategories']] if 'includedCategories' in json else None,
            excluded_categories=[
                str(i) for i in json['excludedCategories']] if 'excludedCategories' in json else None,
            synthetic_delays=[
...
class BufferUsage:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BufferUsage:
        return cls(
            percent_full=float(
                json['percentFull']) if 'percentFull' in json else None,
            event_count=float(
                json['eventCount']) if 'eventCount' in json else None,
