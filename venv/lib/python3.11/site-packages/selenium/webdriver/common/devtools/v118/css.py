    ...
    def from_json(cls, json):
        return cls(
            ...
            pseudo_identifier=str(
                json['pseudoIdentifier']) if 'pseudoIdentifier' in json else None,
        )
...
class InheritedStyleEntry:
    ...
    def from_json(cls, json):
        return cls(
            matched_css_rules=[RuleMatch.from_json(
                i) for i in json['matchedCSSRules']],
            inline_style=CSSStyle.from_json(
                json['inlineStyle']) if 'inlineStyle' in json else None,
        )
...
class InheritedPseudoElementMatches:
    ...
    def from_json(cls, json):
        return cls(
            pseudo_elements=[PseudoElementMatches.from_json(
                i) for i in json['pseudoElements']],
        )
...
class Value:
    ...
    def from_json(cls, json):
        return cls(
            text=str(json['text']),
            range_=SourceRange.from_json(
                json['range']) if 'range' in json else None,
            specificity=Specificity.from_json(
                json['specificity']) if 'specificity' in json else None,
        )
...
class CSSStyleSheetHeader:
    ...
    def from_json(cls, json):
        return cls(
            ...
            source_map_url=str(
                json['sourceMapURL']) if 'sourceMapURL' in json else None,
            owner_node=dom.BackendNodeId.from_json(
                json['ownerNode']) if 'ownerNode' in json else None,
            has_source_url=bool(
                json['hasSourceURL']) if 'hasSourceURL' in json else None,
            loading_failed=bool(
                json['loadingFailed']) if 'loadingFailed' in json else None,
        )
...
class CSSRule:
    ...
    def to_json(self):
        ...
        if self.container_queries is not None:
            json['containerQueries'] = [i.to_json()
                                        for i in self.container_queries]
    ...
    def from_json(cls, json):
        return cls(
            ...
            style_sheet_id=StyleSheetId.from_json(
                json['styleSheetId']) if 'styleSheetId' in json else None,
            nesting_selectors=[
                str(i) for i in json['nestingSelectors']] if 'nestingSelectors' in json else None,
            media=[CSSMedia.from_json(
                i) for i in json['media']] if 'media' in json else None,
            container_queries=[CSSContainerQuery.from_json(
                i) for i in json['containerQueries']] if 'containerQueries' in json else None,
            supports=[CSSSupports.from_json(
                i) for i in json['supports']] if 'supports' in json else None,
            layers=[CSSLayer.from_json(
                i) for i in json['layers']] if 'layers' in json else None,
            scopes=[CSSScope.from_json(
                i) for i in json['scopes']] if 'scopes' in json else None,
            rule_types=[CSSRuleType.from_json(
                i) for i in json['ruleTypes']] if 'ruleTypes' in json else None,
        )
...
class CSSStyle:
    ...
    def to_json(self):
        ...
        json['shorthandEntries'] = [i.to_json()
                                    for i in self.shorthand_entries]
        if self.style_sheet_id is not None:
            json['styleSheetId'] = self.style_sheet_id.to_json()
    ...
    def from_json(cls, json):
        return cls(
            css_properties=[CSSProperty.from_json(
                i) for i in json['cssProperties']],
            shorthand_entries=[ShorthandEntry.from_json(
                i) for i in json['shorthandEntries']],
            style_sheet_id=StyleSheetId.from_json(
                json['styleSheetId']) if 'styleSheetId' in json else None,
...
class CSSProperty:
    ...
    def to_json(self):
        ...
        if self.longhand_properties is not None:
            json['longhandProperties'] = [i.to_json()
                                          for i in self.longhand_properties]
        return json
    ...
    def from_json(cls, json):
        return cls(
            ...
            range_=SourceRange.from_json(
                json['range']) if 'range' in json else None,
            longhand_properties=[CSSProperty.from_json(
                i) for i in json['longhandProperties']] if 'longhandProperties' in json else None,
        )
...
class CSSMedia:
    ...
    def from_json(cls, json):
        return cls(
            ...
            style_sheet_id=StyleSheetId.from_json(
                json['styleSheetId']) if 'styleSheetId' in json else None,
            media_list=[MediaQuery.from_json(
                i) for i in json['mediaList']] if 'mediaList' in json else None,
        )
...
class MediaQuery:
    ...
    def from_json(cls, json):
        return cls(
            expressions=[MediaQueryExpression.from_json(
                i) for i in json['expressions']],
...
class MediaQueryExpression:
    ...
    def from_json(cls, json):
        return cls(
            ...
            value_range=SourceRange.from_json(
                json['valueRange']) if 'valueRange' in json else None,
            computed_length=float(
                json['computedLength']) if 'computedLength' in json else None,
        )
...
class CSSContainerQuery:
    ...
    def from_json(cls, json):
        return cls(
            ...
            physical_axes=dom.PhysicalAxes.from_json(
                json['physicalAxes']) if 'physicalAxes' in json else None,
            logical_axes=dom.LogicalAxes.from_json(
                json['logicalAxes']) if 'logicalAxes' in json else None,
        )
...
class CSSLayerData:
    ...
    def from_json(cls, json):
        return cls(
            ...
            sub_layers=[CSSLayerData.from_json(
                i) for i in json['subLayers']] if 'subLayers' in json else None,
        )
...
class FontFace:
    ...
    def to_json(self):
        ...
        if self.font_variation_axes is not None:
            json['fontVariationAxes'] = [i.to_json()
                                         for i in self.font_variation_axes]
        return json
    ...
    def from_json(cls, json):
        return cls(
            ...
            font_variation_axes=[FontVariationAxis.from_json(
                i) for i in json['fontVariationAxes']] if 'fontVariationAxes' in json else None,
        )
...
class CSSKeyframesRule:
    ...
    def from_json(cls, json):
        return cls(
            ...
            keyframes=[CSSKeyframeRule.from_json(
                i) for i in json['keyframes']],
        )
...
class CSSPropertyRegistration:
    ...
    def from_json(cls, json):
        return cls(
            ...
            initial_value=Value.from_json(
                json['initialValue']) if 'initialValue' in json else None,
        )
...
def get_computed_style_for_node(
    ...
    json = yield cmd_dict
    return [CSSComputedStyleProperty.from_json(
        i) for i in json['computedStyle']]
...
def get_inline_styles_for_node(
    ...
    return (
        ...
        CSSStyle.from_json(json['attributesStyle']
                           ) if 'attributesStyle' in json else None
    )
...
def get_matched_styles_for_node(
    ...
    return (
        ...
        [RuleMatch.from_json(i) for i in json['matchedCSSRules']
         ] if 'matchedCSSRules' in json else None,
        [PseudoElementMatches.from_json(
            i) for i in json['pseudoElements']] if 'pseudoElements' in json else None,
        [InheritedStyleEntry.from_json(
            i) for i in json['inherited']] if 'inherited' in json else None,
        [InheritedPseudoElementMatches.from_json(
            i) for i in json['inheritedPseudoElements']] if 'inheritedPseudoElements' in json else None,
        [CSSKeyframesRule.from_json(
            i) for i in json['cssKeyframesRules']] if 'cssKeyframesRules' in json else None,
        [CSSPositionFallbackRule.from_json(
            i) for i in json['cssPositionFallbackRules']] if 'cssPositionFallbackRules' in json else None,
        [CSSPropertyRule.from_json(
            i) for i in json['cssPropertyRules']] if 'cssPropertyRules' in json else None,
        [CSSPropertyRegistration.from_json(
            i) for i in json['cssPropertyRegistrations']] if 'cssPropertyRegistrations' in json else None,
        dom.NodeId.from_json(
            json['parentLayoutNodeId']) if 'parentLayoutNodeId' in json else None
    )
...
def take_coverage_delta() -> typing.Generator[T_JSON_DICT,
                                              T_JSON_DICT, typing.Tuple[typing.List[RuleUsage], float]]:
    '''
