...
class ActionChains:
    ...
    def __init__(self, driver: WebDriver, duration: int = 250,
                 devices: list[AnyDevice] | None = None) -> None:
    ...
    def click_and_hold(self, on_element: WebElement |
                       None = None) -> ActionChains:
    ...
    def context_click(self, on_element: WebElement |
                      None = None) -> ActionChains:
    ...
    def double_click(self, on_element: WebElement |
                     None = None) -> ActionChains:
    ...
    def drag_and_drop(self, source: WebElement,
                      target: WebElement) -> ActionChains:
    ...
    def drag_and_drop_by_offset(
            self, source: WebElement, xoffset: int, yoffset: int) -> ActionChains:
        """Holds down the left mouse button on the source element, then moves
    ...
    def key_down(self, value: str, element: WebElement |
                 None = None) -> ActionChains:
    ...
    def key_up(self, value: str, element: WebElement |
               None = None) -> ActionChains:
    ...
    def move_to_element_with_offset(
            self, to_element: WebElement, xoffset: int, yoffset: int) -> ActionChains:
    ...
    def send_keys_to_element(self, element: WebElement,
                             *keys_to_send: str) -> ActionChains:
    ...
    def scroll_from_origin(self, scroll_origin: ScrollOrigin,
                           delta_x: int, delta_y: int) -> ActionChains:
